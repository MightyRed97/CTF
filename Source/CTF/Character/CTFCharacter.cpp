...
ACTFCharacter::ACTFCharacter()
{
	...
	{
		PlayerTagWidgetComponent->SetWidgetClass(HealthBarWidgetClass.Class);
	}
}
...
void ACTFCharacter::OnHoldingFlagChanged(bool bIsHoldingFlag)
{
	...
	{
		PlayerTagWidget->UpdateHoldingFlagStatus(bIsHoldingFlag);
	}
}
...
void ACTFCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this, &ACTFCharacter::Fire);
	}
	else
	{
